...
- Digital Promise AI Literacy Framework (Understand / Evaluate / Use): [AI Literacy page](https://digitalpromise.org/initiative/artificial-intelligence-in-education/ai-literacy/), [Executive Summary PDF](https://digitalpromise.org/wp-content/uploads/2024/06/24cLSR0009-Exec-Summary-AI-Literacy-Framework-Paper_FINAL.pdf), [Infographic PDF](https://digitalpromise.org/wp-content/uploads/2024/04/24cLSR0009-Infographic-AI-Literacy-Framework-Paper_FINAL.pdf)
...
- AILit: `AILIT:ENGAGE`, `AILIT:CREATE`, `AILIT:MANAGE`, `AILIT:DESIGN`
Rows may include multiple tags (e.g., `DP:EVALUATE` + `AILIT:MANAGE`) when a single move spans frameworks.

## One worked example
Assignment row set (grade 5 math, “Define a line”):
- Content rows:
  - `Define a line in your own words with a visual example.`
  - `Explain how a line differs from a line segment.`
- AI/context rows (tagged):
  - Tags: `DP:UNDERSTAND, AILIT:ENGAGE`
    Row: `State what you asked the AI and why it helped (or didn’t).`
  - Tags: `DP:EVALUATE, AILIT:MANAGE`
    Row: `Verify one AI claim using class notes/text and record any correction.`
